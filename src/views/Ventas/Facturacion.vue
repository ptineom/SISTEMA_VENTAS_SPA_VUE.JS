    ...
    <v-row>
      <v-col cols="12" md="6" class="py-0 px-1">
        <v-card elevation="1" tile :disabled="bSeleccionarComprobante">
          <v-card-title class="py-1 text-body-1">
          ...
          <v-card-text class="pt-2 pb-0">
            <v-row>
              <v-col cols="12" sm="5" md="5" class="pt-0 px-1">
                <v-select
                  dense
              ...
              <v-col cols="5" sm="3" md="3" class="pt-0 px-1">
                <v-text-field
                  label="Serie"
                  type="text"
                  outlined
              ...
              <v-col cols="7" sm="4" md="4" class="pt-0 px-1">
                <v-text-field
                  label="Número"
                  type="text"
                  outlined
            ...
            <v-row>
              <v-col cols="6" sm="4" class="pt-0 px-1">
                <v-menu
                  v-model="showFecEmi"
              ...
              <v-col cols="12" sm="4" class="pt-0 px-1">
                <v-menu
                  ref="txtFecVen"
                  v-model="showFecVen"
                  transition="scale-transition"
      ...
      <v-col cols="12" md="6" class="py-0 px-1">
        <v-card elevation="1" tile :disabled="bSeleccionarComprobante">
          ...
          <v-card-text class="pt-2 pb-0">
            <v-row>
              <v-col cols="12" md="5" class="pt-0 px-1">
                <v-select
                  dense
              ...
              <v-col cols="12" md="7" class="pt-0 px-1">
                <v-text-field
                  label="N° documento"
                  type="text"
                  outlined
                ...
                <DlgRegistrarCliente
                  ref="dlgRegistrarCliente"
                  :listaTipoDocumento="arrDocumentosConsulta"
                  :listaDepartamento="arrDepartamentos"
                >
                </DlgRegistrarCliente>
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="12" sm="3" md="4" class="pt-0 px-1">
                <v-text-field
                  label="Código"
                  type="text"
                  outlined
              ...
              <v-col cols="12" sm="9" md="8" class="pt-0 px-1">
                <v-text-field
                  label="Cliente"
                  type="text"
                  outlined
            ...
            <v-row>
              ...
              <v-col cols="12" sm="8" md="6" class="pt-0">
                ...
                <DlgBuscarArticulo
                  ...
                  @seleccionarRegistro="getArticuloModal($event)"
                ></DlgBuscarArticulo>
              </v-col>
                  ...
                  <tr v-for="(item, i) in items" :key="i">
                    ...
                    <td class="">
                      <v-text-field
                        ...
                        ref="descuento1_x"
                        @keyup.enter.native="
                          $refs.importe_x[i].$refs.txtCurrencyInput.focus()
                        "
                      ></v-text-field>
                    </td>
                    <td class="">
          ...
          <v-card-text class="py-0">
            <v-row>
              ...
              <v-col cols="12" md="5" class="py-0">
                <v-row>
                  <v-col cols="4" md="3" class="pb-0 pt-1">
                    <span class="font-weight-bold">Sub total</span>
                  </v-col>
                  <v-col cols="8" md="6" offset-md="3" class="py-0">
                    <v-text-field
                      type="text"
                      reverse
                      dense
      ...
      <v-col md="12" class="pt-0">
        <div class="text-right">
          ...
          <v-btn
            ...
            class="mr-1"
            @click="pagar()"
            :disabled="bSeleccionarComprobante"
          >
          ...
          <v-btn class="mr-1" color="primary" @click.stop="buscarVenta()">
